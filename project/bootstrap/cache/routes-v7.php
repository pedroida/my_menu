  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ProductController@getThumb',
        'controller' => 'App\\Http\\Controllers\\ProductController@getThumb',
        'namespace' => NULL,
        'prefix' => NULL,
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CategoryController@pagination',
        'controller' => 'App\\Http\\Controllers\\CategoryController@pagination',
        'namespace' => NULL,
        'prefix' => NULL,
        'where' => 
        array (
        ),
        'as' => 'pagination.categories',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UnitController@pagination',
        'controller' => 'App\\Http\\Controllers\\UnitController@pagination',
        'namespace' => NULL,
        'prefix' => NULL,
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserController@pagination',
        'controller' => 'App\\Http\\Controllers\\UserController@pagination',
        'namespace' => NULL,
        'prefix' => NULL,
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ProductController@pagination',
        'controller' => 'App\\Http\\Controllers\\ProductController@pagination',
        'namespace' => NULL,
        'prefix' => NULL,
        'where' => 
        array (
